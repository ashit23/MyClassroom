...
import com.project.myclassroom1.ui.home.MarksAdapter;
import com.project.myclassroom1.ui.home.SubmittedAdapter;
...
public class ResultClass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marksAdapter = new MarksAdapter(this, myDetailList);
        recyclerView.setAdapter(marksAdapter);
        myDetails();
    }

    private void myDetails() {
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Marks");
