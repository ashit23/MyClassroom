...
import com.project.myclassroom1.Calender;
import com.project.myclassroom1.R;
import com.project.myclassroom1.Test;

import java.util.ArrayList;

public class ChooseClassCalenderAdapter  extends RecyclerView.Adapter<ChooseClassCalenderAdapter.MyViewHolder>{


    Context context;
    ArrayList<Classes> myClasses;

    public ChooseClassCalenderAdapter(Context context, ArrayList<Classes> myClasses) {
    ...
    @NonNull
    @Override
    public ChooseClassCalenderAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(context).inflate(R.layout.choose_layout,parent,false);
        return new ChooseClassCalenderAdapter.MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull ChooseClassCalenderAdapter.MyViewHolder holder, int position) {
